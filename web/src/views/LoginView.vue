  ...
  <div class="min-h-screen flex items-center justify-center p-4 relative overflow-hidden bg-gray-50 dark:bg-slate-950 transition-colors duration-300">
    ...
    <div class="relative w-full max-w-sm card-enter">
      <div class="bg-white/90 dark:bg-slate-900/95 backdrop-blur-xl rounded-3xl shadow-2xl shadow-slate-300/60 dark:shadow-black/50 border border-white/80 dark:border-slate-700/50 overflow-hidden">
        ...
        <!-- Brand -->
        <div class="pt-9 pb-7 px-8 text-center">
          <div class="icon-enter w-14 h-14 bg-gradient-to-br from-blue-500 to-violet-600 rounded-2xl flex items-center justify-center mx-auto mb-5 shadow-lg shadow-blue-500/30">
        ...
        <!-- Gradient divider -->
        <div class="mx-8 h-px bg-gradient-to-r from-transparent via-gray-200 dark:via-slate-700/80 to-transparent" />
        ...
        <div class="form-enter px-8 py-7">
          <form @submit.prevent="handleSubmit" class="space-y-5">
            ...
            <div>
              ...
              <div class="relative group">
                ...
                <input
                  ...
                  class="w-full pl-10 pr-4 py-3 rounded-xl text-sm border border-gray-200 dark:border-slate-700 bg-gray-50 dark:bg-slate-800/80 text-gray-900 dark:text-slate-100 placeholder-gray-400 dark:placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 focus:bg-white dark:focus:bg-slate-800 transition-all duration-200"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div class="relative group">
                ...
                <input
                  ...
                  required
                  placeholder="••••••••"
                  class="w-full pl-10 pr-11 py-3 rounded-xl text-sm border border-gray-200 dark:border-slate-700 bg-gray-50 dark:bg-slate-800/80 text-gray-900 dark:text-slate-100 placeholder-gray-400 dark:placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 focus:bg-white dark:focus:bg-slate-800 transition-all duration-200"
                />
                <button
                  type="button"
            ...
            >
              <div
                v-if="error"
                class="flex items-center gap-2.5 text-red-700 dark:text-red-400 text-sm bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800/40 px-4 py-3 rounded-xl"
              >
            ...
            <button
              type="submit"
              :disabled="loading"
              class="w-full py-3.5 rounded-xl font-bold text-sm text-white bg-gradient-to-r from-blue-600 to-violet-600 hover:from-blue-500 hover:to-violet-500 shadow-lg shadow-blue-500/30 hover:shadow-xl hover:shadow-blue-500/40 disabled:opacity-60 disabled:cursor-not-allowed transition-all duration-300 hover:-translate-y-0.5 active:translate-y-0 active:shadow-md flex items-center justify-center gap-2"
            >
...
/* Form block fade up */
.form-enter {
  animation: fadeUp 0.45s 0.38s ease-out both;
}
