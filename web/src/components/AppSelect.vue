<template>
  <div class="relative" ref="rootRef">
    ...
    >
      <!-- Color dot for status-like options -->
    ...
    >
      <div
        v-if="open"
        class="absolute z-50 mt-1.5 bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-xl shadow-xl overflow-hidden"
...
const props = defineProps({
  modelValue: { default: '' },
  options: { type: Array, default: () => [] }, // [{ value, label, dot? }]
